      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " has been update"));
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Success ! Password has changed');
              window.setTimeout(function () {
...
var stripe = Stripe('pk_test_ALq5FzD2iG4AqmtKvbrHz1Ij00kVa99ImV');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2) Create checkout form + chanre creadit card
...
exports.deleteReview = exports.reviewForm = void 0;
...
var reviewForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, rating, review) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Reviews success');
            }
  ...
  return function reviewForm(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/review/".concat(reviewId)
            });
          ...
          case 3:
            ...
            if (res.data.status == null) {
              (0, _alert.showAlert)('success', 'Reviews Deleted');
            }
...
exports.sendVerifyEmail = exports.signup = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Success Signup');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Success,Please Check Your Email');
            }
...
var forgotPasswordBtn = document.querySelector('.form-forgot-password');
var resetPasswordBtn = document.querySelector('.form-reset-password');
var bookBtn = document.getElementById('book-tour');
var signUpBtn = document.getElementById('form-sign-up');
var verifBtn = document.getElementById('verifAccount');
var reviewBtn = document.getElementById('form--review');
var deleteReviewBtn = document.getElementById('form--review__delete'); // DELEGATION
...
if (forgotPasswordBtn) {
  forgotPasswordBtn.addEventListener('submit', /*#__PURE__*/function () {
...
if (resetPasswordBtn) {
  resetPasswordBtn.addEventListener('submit', function (e) {
    ...
    var tokenId = resetBtn.dataset.usertoken;
    (0, _forgotPassword.resetPassword)(tokenId, password, passwordConfirm);
  });
}
